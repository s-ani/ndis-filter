...
#define FILTER_FRIENDLY_NAME        L"BasicNdisFilter NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{e483cefd-fb35-4925-ac19-4edf004f0227}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"BasicNdisFilter"

//
// The filter needs to handle IOCTLs
//
#define LINKNAME_STRING             L"\\DosDevices\\BasicNdisFilter"
#define NTDEVICE_STRING             L"\\Device\\BasicNdisFilter"
...
DRIVER_DISPATCH BasicNdisFilterDispatch;

DRIVER_DISPATCH BasicNdisFilterDeviceIoControl;
